...
public class ArmorProficiency {
    ...
    // FIX: aggiunti nullable=false e unique=true. "name" è di fatto la chiave
    // logica con cui questa proficiency viene referenziata (catalogo condiviso
    // tra più classi): prima nulla impediva nomi duplicati o null a DB.
